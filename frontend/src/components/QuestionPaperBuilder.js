      ...
      <div className="main-content">
        ...
        <div className="student-info">
          ...
          <input
            ...
            placeholder="e.g., Global Academy of Technology, Bengaluru"
          />
                  ...
                  {group.map((q, qIndex) => (
                    <div key={qIndex} className="question-row">
                      ...
                      <input
                        value={q.text}
                        onChange={(e) =>
                          updateQuestion(modIndex, groupIndex, qIndex, 'text', e.target.value)
                        }
                      ...
                      <input
                        value={q.co}
                        onChange={(e) =>
                          updateQuestion(modIndex, groupIndex, qIndex, 'co', e.target.value)
                        }
                        placeholder="CO"
                        className="small"
                      />
